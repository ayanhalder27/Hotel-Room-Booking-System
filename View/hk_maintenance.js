...
function loadRoomSelect(){
    getData("../Controler/hk_rooms.php?action=room_board", function(data){
...
function logMaintenance(form){
    ...
    postData("../Controler/hk_maintenance.php", formData, function(data){
        if(data.success){
...
function loadMaintenanceReports(){
    getData("../Controler/hk_maintenance.php?action=maintenance_reports", function(data){
        let output = "";
