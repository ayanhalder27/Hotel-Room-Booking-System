...
<head>
    ...
    <title>LuxeStay - Manage Rooms</title>
    ...
    <style>
        ...
        * {
        ...
        .badge.available { background: rgba(34, 197, 94, 0.1); color: var(--success); border: 1px solid rgba(34, 197, 94, 0.2); }
        .badge.occupied { background: rgba(59, 130, 246, 0.1); color: var(--info); border: 1px solid rgba(59, 130, 246, 0.2); }
        .badge.dirty { background: rgba(245, 158, 11, 0.1); color: var(--warning); border: 1px solid rgba(245, 158, 11, 0.2); }
        .badge.maintenance { background: rgba(239, 68, 68, 0.1); color: var(--danger); border: 1px solid rgba(239, 68, 68, 0.2); }
        .badge.blocked { background: rgba(170, 170, 170, 0.1); color: var(--text-secondary); border: 1px solid rgba(170, 170, 170, 0.2); }
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <button class="nav-item active" onclick="window.location.href='manage-rooms.php'">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="color: var(--text-secondary); font-size: 0.85rem;">Cleaned and ready.</td>
                        <td>
                    ...
                    <tr>
                        <td class="room-number">102</td>
                        <td>Standard Twin</td>
                        <td>1</td>
                        <td><span class="badge occupied">Occupied</span></td>
                        <td style="color: var(--text-secondary); font-size: 0.85rem;">Checkout tomorrow at 11 AM.</td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-icon" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button>
                                <button class="btn-icon delete" title="Delete"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button>
                    ...
                    <tr>
                        <td class="room-number">205</td>
                        <td>Deluxe King</td>
                        <td>2</td>
                        <td><span class="badge dirty">Dirty</span></td>
                        <td style="color: var(--text-secondary); font-size: 0.85rem;">Pending housekeeping.</td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-icon" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button>
                                <button class="btn-icon delete" title="Delete"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button>
                    ...
                    <tr>
                        <td class="room-number">401</td>
                        <td>Executive Suite</td>
                        <td>4</td>
                        <td><span class="badge maintenance">Maintenance</span></td>
                        <td style="color: var(--text-secondary); font-size: 0.85rem;">AC repair required. Ticket #8023.</td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-icon" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button>
                                <button class="btn-icon delete" title="Delete"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button>
                    ...
                    <tr>
                        <td class="room-number">505</td>
                        <td>Presidential Suite</td>
                        <td>5</td>
                        <td><span class="badge blocked">Blocked</span></td>
                        <td style="color: var(--text-secondary); font-size: 0.85rem;">Reserved for VIP guest next week.</td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-icon" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button>
                                <button class="btn-icon delete" title="Delete"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button>
    ...
    <div class="modal-overlay" id="roomModal">
        <div class="modal-content">
            ...
            <form id="roomForm" action="process_room.php" method="POST">
                <input type="hidden" id="roomId" name="room_id">
                
                <div class="form-row">
                    <div class="form-group">
                        <label for="roomNumber">Room Number *</label>
                        <input type="text" id="roomNumber" name="room_number" class="form-control" placeholder="e.g., 101" required>
                    </div>
                    <div class="form-group">
                        <label for="floor">Floor *</label>
                        <input type="number" id="floor" name="floor" class="form-control" placeholder="e.g., 1" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="roomType" name="room_type_id" class="form-control" required>
                            ...
                            <!-- In PHP, populate these options dynamically from room_types table -->
                ...
                <div class="form-group">
                    ...
                    <textarea id="notes" name="notes" class="form-control" placeholder="Any special remarks regarding this specific room..."></textarea>
                </div>

                <div class="modal-footer">
                    <button type="button" class="btn-secondary" id="cancelModalBtn">Cancel</button>
                    <button type="submit" class="btn-primary">Save Room Details</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Mock functionality for the Edit buttons to show how the modal updates
            ...
            editButtons.forEach(btn => {
                btn.addEventListener('click', (e) => {
                    ...
                    // Here you would typically fetch room details via AJAX or extract from row data
                    // This is just to demonstrate the UI behavior
                    const row = e.target.closest('tr');
                    const roomNo = row.querySelector('.room-number').innerText;
                    
                    document.getElementById('roomNumber').value = roomNo;
                    // Additional mock population could go here...
