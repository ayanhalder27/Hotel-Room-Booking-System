...
<head>
    ...
    <style>
        ...
        * {
        ...
        .filter-box input[type="date"]::after { content: none; }

        .filter-box select:focus, .filter-box input[type="date"]:focus { outline: none; border-color: var(--gold); }
        ...
        .breakdown-header .amount { font-weight: 600; color: var(--text-secondary); }
        ...
        .badge.room { background: rgba(212, 175, 55, 0.1); color: var(--gold); border: 1px solid rgba(212, 175, 55, 0.2); }
        .badge.extras { background: rgba(139, 92, 246, 0.1); color: var(--purple); border: 1px solid rgba(139, 92, 246, 0.2); }
        .badge.paid { background: rgba(34, 197, 94, 0.1); color: var(--success); border: 1px solid rgba(34, 197, 94, 0.2); }
        ...
        /* --- Print Styles --- */
        @media print {
            .sidebar, .topbar, .controls-bar, .btn-primary, .btn-outline { display: none !important; }
            ...
            * { color: #000000 !important; }
            ...
            .gold, .amount-cell { color: #000000 !important; font-weight: bold !important; }
    ...
    <main class="main-content">
        ...
        <div class="summary-grid">
            <div class="summary-card">
                ...
                <div class="value">$124,500.00</div>
            ...
            <div class="summary-card">
                <h3>Rooms Revenue</h3>
                <div class="value">$108,250.00</div>
                <div class="trend text-success">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg>
            ...
            <div class="summary-card">
                ...
                <div class="value" style="color: var(--text-primary);">$285.50</div>
