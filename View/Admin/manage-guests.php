...
<head>
    ...
    <title>LuxeStay - Manage Guests</title>
    ...
    <style>
        ...
        * {
        ...
        .btn-icon.deactivate:hover { color: var(--danger); border-color: var(--danger); background: rgba(239, 68, 68, 0.1); }
        .btn-icon.activate:hover { color: var(--success); border-color: var(--success); background: rgba(34, 197, 94, 0.1); }
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <button class="nav-item active" onclick="window.location.href='manage-guests.php'">
    ...
    <main class="main-content">
        ...
        <header class="topbar">
            <div class="page-title-group">
                ...
                <p class="page-subtitle">View profiles, enforce policies, and deactivate guest accounts.</p>
            </div>
        ...
        <div class="controls-bar">
            <div class="filters-group">
                <div class="search-box" style="flex: 1; max-width: 400px;">
                    ...
                    <input type="text" placeholder="Search by Name, Email, or National ID..." style="width: 100%;">
                </div>
                ...
                <div class="filter-box">
                    <select name="status_filter">
                        ...
                        <option value="0">Deactivated (Policy Violation)</option>
                    </select>
                </div>
            </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="guest-info">
                                <img src="https://ui-avatars.com/api/?name=Robert+Smith&background=random" alt="Robert" class="guest-avatar">
                                <div class="guest-details">
                                    <span class="guest-name">Robert Smith</span>
                                    <span class="guest-email">robert.smith@email.com</span>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div style="font-size: 0.9rem;">+1 (555) 123-4567</div>
                            <div style="font-size: 0.8rem; color: var(--text-secondary);">@rob_smith</div>
                        </td>
                        <td>
                            <div style="font-size: 0.9rem; color: var(--text-primary);">United States</div>
                            <span class="id-text">ID: P123456789</span>
                        </td>
                        <td><span class="badge active">Active</span></td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-icon" title="View Bookings"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg></button>
                                ...
                                <button class="btn-icon deactivate" title="Deactivate (Policy Violation)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M18.36 6.64a9 9 0 1 1-12.73 0"></path><line x1="12" y1="2" x2="12" y2="12"></line></svg></button>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="guest-info">
                                <img src="https://ui-avatars.com/api/?name=Chen+Wei&background=random" alt="Chen" class="guest-avatar">
                                <div class="guest-details">
                                    <span class="guest-name">Chen Wei</span>
                                    <span class="guest-email">chen.wei99@mail.cn</span>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div style="font-size: 0.9rem;">+86 138 0013 8000</div>
                            <div style="font-size: 0.8rem; color: var(--text-secondary);">@chen_w</div>
                        </td>
                        <td>
                            <div style="font-size: 0.9rem; color: var(--text-primary);">China</div>
                            <span class="id-text">ID: E98765432</span>
                        </td>
                        <td><span class="badge active">Active</span></td>
                        <td>
                            <div class="action-btns">
                    ...
                    <tr>
                        <td>
                            <div class="guest-info">
                                <img src="https://ui-avatars.com/api/?name=Amanda+Clarke&background=random" alt="Amanda" class="guest-avatar">
                                <div class="guest-details">
                                    <span class="guest-name" style="text-decoration: line-through; color: var(--text-secondary);">Amanda Clarke</span>
                                    <span class="guest-email">amanda.c88@email.com</span>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div style="font-size: 0.9rem; color: var(--text-secondary);">+44 7911 123456</div>
                            <div style="font-size: 0.8rem; color: var(--text-secondary);">@mandy_c</div>
                        </td>
                        <td>
                            <div style="font-size: 0.9rem; color: var(--text-secondary);">United Kingdom</div>
                            <span class="id-text">ID: B23456781</span>
                        </td>
                        <td><span class="badge inactive">Deactivated</span></td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-icon" title="View Bookings"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg></button>
                                <button class="btn-icon" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button>
                                <button class="btn-icon activate" title="Reactivate Account"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg></button>
                            </div>
                        </td>
                    </tr>
                </tbody>
    ...
    <div class="modal-overlay" id="guestModal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modalTitle">Add Walk-in Guest</h2>
            ...
            <form id="guestForm" action="process_guest.php" method="POST">
                <input type="hidden" id="guestId" name="id">
                <input type="hidden" name="role" value="guest"> <!-- Hidden field to ensure role is always guest -->
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="phone" name="phone" class="form-control" placeholder="+1 234 567 8900" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="nationality" name="nationality" class="form-control" placeholder="e.g., United States" required>
                    </div>
                    <div class="form-group">
                        <label for="nationalId">National ID / Passport No. *</label>
                        <input type="text" id="nationalId" name="national_id" class="form-control" placeholder="Passport or ID Number" required>
                    </div>
                </div>

                <div class="form-group">
                    <label for="status">Account Status *</label>
                    <select id="status" name="is_active" class="form-control" required>
                        <option value="1">Active</option>
                        <option value="0">Deactivated (Policy Violation)</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small style="color: var(--text-secondary); display: block; margin-top: 5px;" id="passwordHelp">Leave blank if you do not wish to change the current password.</small>
                </div>

                <div class="modal-footer">
                    <button type="button" class="btn-secondary" id="cancelModalBtn">Cancel</button>
                    <button type="submit" class="btn-primary">Save Guest Details</button>
                </div>
            </form>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            editButtons.forEach(btn => {
                btn.addEventListener('click', (e) => {
                    e.preventDefault();
                    document.getElementById('modalTitle').innerText = 'Edit Guest Profile';
                    
                    const row = e.target.closest('tr');
                    const guestName = row.querySelector('.guest-name').innerText;
                    
                    // Pre-fill the form (mocked)
                    document.getElementById('fullName').value = guestName;
                    passwordHelp.innerText = "Leave blank if you do not wish to change the current password.";
