...
<head>
    ...
    <title>LuxeStay - Manage Staff</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <button class="nav-item active" onclick="window.location.href='manage-staff.php'">
    ...
    <main class="main-content">
        ...
        <header class="topbar">
            <div class="page-title-group">
                ...
                <p class="page-subtitle">Create, edit, and deactivate employee accounts.</p>
            </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="staff-info">
                                <img src="https://ui-avatars.com/api/?name=Emma+Watson&background=random" alt="Emma" class="staff-avatar">
                                <div class="staff-details">
                                    <span class="staff-name">Emma Watson</span>
                                    <span class="staff-email">emma.reception@luxestay.com</span>
                                </div>
                            </div>
                        </td>
                        <td><span class="role-text">Receptionist</span></td>
                        <td>
                            <div style="font-size: 0.9rem;">+1 (555) 123-4567</div>
                            <div style="font-size: 0.8rem; color: var(--text-secondary);">@emma_r</div>
                        </td>
                        ...
                        <td>
                            <div class="action-btns">
                                ...
                                <button class="btn-icon deactivate" title="Deactivate"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M18.36 6.64a9 9 0 1 1-12.73 0"></path><line x1="12" y1="2" x2="12" y2="12"></line></svg></button>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="staff-info">
                                <img src="https://ui-avatars.com/api/?name=Marcus+Johnson&background=random" alt="Marcus" class="staff-avatar">
                                <div class="staff-details">
                                    <span class="staff-name">Marcus Johnson</span>
                                    <span class="staff-email">marcus.h@luxestay.com</span>
                                </div>
                            </div>
                        </td>
                        <td><span class="role-text">Housekeeping</span></td>
                        <td>
                            <div style="font-size: 0.9rem;">+1 (555) 987-6543</div>
                            <div style="font-size: 0.8rem; color: var(--text-secondary);">@marcus_h</div>
                        </td>
                        <td><span class="badge active">Active</span></td>
                        <td>
                            <div class="action-btns">
                    ...
                    <tr>
                        <td>
                            <div class="staff-info">
                                <img src="https://ui-avatars.com/api/?name=Sarah+Connor&background=random" alt="Sarah" class="staff-avatar">
                                <div class="staff-details">
                                    <span class="staff-name">Sarah Connor</span>
                                    <span class="staff-email">sarah.c@luxestay.com</span>
                                </div>
                            </div>
                        </td>
                        <td><span class="role-text" style="color: var(--text-secondary);">Receptionist</span></td>
                        <td>
                            <div style="font-size: 0.9rem; color: var(--text-secondary);">+1 (555) 444-5555</div>
                            <div style="font-size: 0.8rem; color: var(--text-secondary);">@sarah_c</div>
                        </td>
                        <td><span class="badge inactive">Inactive</span></td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-icon" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button>
                                <button class="btn-icon activate" title="Reactivate"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg></button>
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <form id="staffForm" action="process_staff.php" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control" placeholder="john@luxestay.com" required>
                    </div>
                    <div class="form-group">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            editButtons.forEach(btn => {
                btn.addEventListener('click', (e) => {
                    ...
                    const staffName = row.querySelector('.staff-name').innerText;
                    
                    // Pre-fill the form (mocked)
                    document.getElementById('fullName').value = staffName;
