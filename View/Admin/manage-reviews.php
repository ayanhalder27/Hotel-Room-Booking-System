...
<head>
    ...
    <title>LuxeStay - Guest Reviews</title>
    ...
    <style>
        ...
        * {
        ...
        .summary-details .score {
            font-family: var(--font-heading);
            font-size: 1.8rem;
            font-weight: 600;
            color: var(--text-primary);
        }
        .summary-details .score span {
            font-family: var(--font-body);
            font-size: 0.9rem;
            color: var(--text-secondary);
            font-weight: 400;
        ...
        .star-rating svg { width: 14px; height: 14px; fill: currentColor; }
        .star-rating .empty-star { fill: none; stroke: currentColor; stroke-width: 2; }
        ...
        /* Status Badges */
        .badge.replied { background: rgba(34, 197, 94, 0.1); color: var(--success); border: 1px solid rgba(34, 197, 94, 0.2); }
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <button class="nav-item active" onclick="window.location.href='manage-reviews.php'">
    ...
    <main class="main-content">
        ...
        <header class="topbar">
            <div class="page-title-group">
                ...
                <p class="page-subtitle">Read guest feedback and manage official hotel responses.</p>
            </div>
        ...
        <div class="summary-grid">
            <div class="summary-card">
                ...
                <div class="summary-details">
                    ...
                    <div class="score">4.8 <span>/ 5.0</span></div>
                </div>
            </div>
            <div class="summary-card">
                <div class="summary-icon">
            ...
            <div class="summary-card">
                ...
                <div class="summary-details">
                    <h3>Service</h3>
                    <div class="score">4.7 <span>/ 5.0</span></div>
                </div>
            </div>
        </div>
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="guest-info">Alexander Pierce</div>
                            <div class="text-muted-sm">Booking: #BKG-4012</div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="review-snippet">"Absolutely phenomenal experience! The room service was incredibly prompt, and the views from the Executive Suite were breathtaking. Will definitely be returning."</div>
                        </td>
                        <td>
                            <div>Oct 29, 2026</div>
                        </td>
                        <td><span class="badge pending">Pending Reply</span></td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-icon" title="View & Reply" onclick="openReplyModal('Alexander Pierce', 5, 'Absolutely phenomenal experience! The room service was incredibly prompt, and the views from the Executive Suite were breathtaking. Will definitely be returning.')">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                                </button>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="guest-info">Sarah Jenkins</div>
                            <div class="text-muted-sm">Booking: #BKG-4013</div>
                        </td>
                        <td>
                            <div class="star-rating">
                                <svg viewBox="0 0 24 24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                                <svg viewBox="0 0 24 24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                                <svg viewBox="0 0 24 24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                                <svg viewBox="0 0 24 24" class="empty-star"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                                <svg viewBox="0 0 24 24" class="empty-star"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                            </div>
                        </td>
                        <td>
                            <div class="review-snippet">"The room was clean and the location is great, but the check-in process took way too long. The receptionist seemed overwhelmed during peak hours."</div>
                        </td>
                        <td>
                            <div>Oct 28, 2026</div>
                        </td>
                        <td><span class="badge replied">Replied</span></td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-icon" title="View Details" onclick="openReplyModal('Sarah Jenkins', 3, 'The room was clean and the location is great, but the check-in process took way too long. The receptionist seemed overwhelmed during peak hours.', 'Dear Sarah, thank you for your feedback. We apologize for the wait during check-in and are actively working on staffing during peak hours to ensure a smoother experience.')">
                    ...
                    <tr>
                        <td>
                            <div class="guest-info">Michael Chen</div>
                            <div class="text-muted-sm">Booking: #BKG-4014</div>
                        </td>
                        <td>
                            <div class="star-rating">
                                <svg viewBox="0 0 24 24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                        ...
                        <td>
                            <div class="review-snippet">"Very comfortable beds and great amenities. The Wi-Fi could be a bit faster, but overall a solid stay for a business trip."</div>
                        </td>
                        <td>
                            <div>Oct 26, 2026</div>
                        </td>
                        ...
                        <td>
                            <div class="action-btns">
                                <button class="btn-icon" title="View & Reply" onclick="openReplyModal('Michael Chen', 4, 'Very comfortable beds and great amenities. The Wi-Fi could be a bit faster, but overall a solid stay for a business trip.')">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                                </button>
                            </div>
                        </td>
    ...
    <div class="modal-overlay" id="replyModal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modalTitle">Review Details</h2>
            ...
            <div class="review-box">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <strong style="color: var(--text-primary); font-size: 1.1rem;" id="modalGuestName">Guest Name</strong>
                    <div class="star-rating" id="modalStars">
                        <!-- Populated by JS -->
                    </div>
                </div>
                <p id="modalReviewText">"Review text goes here..."</p>
            </div>

            <!-- Reply Form -->
            <form id="replyForm" action="process_review_reply.php" method="POST">
                <input type="hidden" id="reviewId" name="review_id">
                
                <div class="form-group">
                    <label for="hotelReply">Official Hotel Response</label>
                    <textarea id="hotelReply" name="hotel_reply" class="form-control" placeholder="Type your response to the guest here. This will be publicly visible..." required></textarea>
                </div>
    ...
    <script>
        ...
        // Function called from the table buttons to open the modal and populate data
        window.openReplyModal = function(guestName, rating, reviewText, existingReply = '') {
            ...
            const replyTextarea = document.getElementById('hotelReply');
            replyTextarea.value = existingReply;
            
            if(existingReply) {
                document.getElementById('modalTitle').innerText = 'Edit Official Reply';
                document.querySelector('#replyForm button[type="submit"]').innerText = 'Update Reply';
            } else {
                document.getElementById('modalTitle').innerText = 'Post Official Reply';
                document.querySelector('#replyForm button[type="submit"]').innerText = 'Post Reply';
            }
