...
<head>
    ...
    <style>
        ...
        * {
        ...
        .search-box input, .filter-box select, .filter-box input[type="date"] {
        ...
        .search-box input:focus, .filter-box select:focus, .filter-box input[type="date"]:focus { outline: none; border-color: var(--gold); }
        ...
        .badge.checked-out { background: rgba(170, 170, 170, 0.1); color: var(--text-secondary); border: 1px solid rgba(170, 170, 170, 0.2); }
        .badge.cancelled { background: rgba(239, 68, 68, 0.1); color: var(--danger); border: 1px solid rgba(239, 68, 68, 0.2); }
...
<body>
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="booking-id">#BKG-4012</div>
                            <div class="text-muted-sm">Oct 20, 2026</div>
                        </td>
                        <td>
                            <div class="guest-name">Alexander Pierce</div>
                            <div class="text-muted-sm">+1 (555) 012-3456</div>
                        </td>
                        <td>
                            <div style="font-weight: 500; color: var(--text-primary);">Executive Suite</div>
                            <div class="text-muted-sm">Room 401 (Assigned)</div>
                        </td>
                        <td>
                            <div>Oct 24, 2026</div>
                            <div class="text-muted-sm">to Oct 28, 2026 (4 Nights)</div>
                        </td>
                        <td>
                            <div style="font-family: var(--font-heading); font-weight: 600;">$1,800.00</div>
                            <span class="source-tag">Online Booking</span>
                        </td>
                        <td><span class="badge confirmed">Confirmed</span></td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-icon" title="View/Edit Booking"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button>
                                <button class="btn-icon delete" title="Cancel Booking"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg></button>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="booking-id">#BKG-4013</div>
                            <div class="text-muted-sm">Oct 21, 2026</div>
                        </td>
                        <td>
                            <div class="guest-name">Sarah Jenkins</div>
                            <div class="text-muted-sm">+44 7700 900077</div>
                        </td>
                        <td>
                            <div style="font-weight: 500; color: var(--text-primary);">Deluxe King</div>
                            <div class="text-muted-sm">Unassigned</div>
                        </td>
                        <td>
                            <div>Oct 25, 2026</div>
                            <div class="text-muted-sm">to Oct 27, 2026 (2 Nights)</div>
                        </td>
                        <td>
                            <div style="font-family: var(--font-heading); font-weight: 600;">$500.00</div>
                            <span class="source-tag">Online Booking</span>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="booking-id">#BKG-4014</div>
                            <div class="text-muted-sm">Oct 22, 2026</div>
                        </td>
                        <td>
                            <div class="guest-name">Michael Chen</div>
                            <div class="text-muted-sm">+65 9123 4567</div>
                        </td>
                        <td>
                            <div style="font-weight: 500; color: var(--text-primary);">Standard Twin</div>
                            <div class="text-muted-sm">Room 102 (Assigned)</div>
                        </td>
                        <td>
                            <div>Oct 22, 2026</div>
                            <div class="text-muted-sm">to Oct 25, 2026 (3 Nights)</div>
                        </td>
                        <td>
                            <div style="font-family: var(--font-heading); font-weight: 600;">$450.00</div>
                            <span class="source-tag" style="background: rgba(212,175,55,0.1); color: var(--gold);">Walk In</span>
                        </td>
                        <td><span class="badge checked-in">Checked In</span></td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-icon" title="View/Edit Booking"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button>
                                <button class="btn-icon" title="Manage Billing"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg></button>
                            </div>
                        </td>
                    </tr>
                </tbody>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const editButtons = document.querySelectorAll('.btn-icon[title="View/Edit Booking"]');
            editButtons.forEach(btn => {
                btn.addEventListener('click', (e) => {
                    ...
                    const bkgId = row.querySelector('.booking-id').innerText;
                    
                    // Pre-fill the form slightly (mocked)
                    console.log("Editing booking: " + bkgId);
