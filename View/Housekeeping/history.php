...
<main class="main-content">
    <section class="section active">
        <div class="section-header">
            <h2>Task History</h2>
            <p>Historical cleaning log per room</p>
        </div>
        <div class="card">
            <div class="card-header">
                <h3>Filter by Room</h3>
                <select id="historyRoomFilter" class="filter-select">
                    <option value="">All Rooms</option>
                </select>
            </div>
            <div class="table-wrap"><table>
                <thead><tr><th>Room</th><th>Type</th><th>Scheduled Date</th><th>Priority</th><th>Status</th><th>Notes</th><th>Completed</th></tr></thead>
